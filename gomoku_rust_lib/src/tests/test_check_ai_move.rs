...
pub fn test_ai_move() {
    ...
    // apply_bit(&mut bitboards, 180, global_var::PLAYER_WHITE_NB);
    // apply_bit(&mut bitboards, 181, global_var::PLAYER_BLACK_NB);
    // apply_bit(&mut bitboards, 300, global_var::PLAYER_BLACK_NB);
    ...
    // // Test 13, testing pattern two blocked by wall is not counting as a capturable pos.
    // println!("test 13");
    // let mut bitboards: Bitboards = Bitboards {
    //     white_board: [0, 0, 0, 0, 0, 0],
    //     black_board: [0, 0, 0, 0, 0, 0],
    ...
    // // Test 14, testing AI not blocking a double three because one of them is not free.
    // println!("test 14");
    // let mut bitboards: Bitboards = Bitboards {
    //     white_board: [0, 0, 0, 0, 0, 0],
    //     black_board: [0, 0, 0, 0, 0, 0],
    ...
    // apply_bit(&mut bitboards, 201, global_var::PLAYER_WHITE_NB);
    // apply_bit(&mut bitboards, 220, global_var::PLAYER_WHITE_NB);
    // apply_bit(&mut bitboards, 239, global_var::PLAYER_BLACK_NB);
    // let mut state: data_struct::State = state::create_new_state(
    //     &mut bitboards,
    //     global_var::PLAYER_WHITE_NB,
    //     180,
    ...
    // // test 15, testing blocking a three and blocking a two in the same time instead of blocking four and doing a three.
    // println!("test 15");
    // let mut bitboards: Bitboards = Bitboards {
    //     white_board: [0, 0, 0, 0, 0, 0],
    //     black_board: [0, 0, 0, 0, 0, 0],
    ...
    // apply_bit(&mut bitboards, 217, global_var::PLAYER_BLACK_NB);
    // apply_bit(&mut bitboards, 221, global_var::PLAYER_WHITE_NB);
    // apply_bit(&mut bitboards, 240, global_var::PLAYER_BLACK_NB);
    // let mut state: data_struct::State = state::create_new_state(
    //     &mut bitboards,
    //     global_var::PLAYER_WHITE_NB,
    //     180,
