...
pub fn check_win_position(map:&mut Vec<Vec<i32>>, player: i32, x: i32, y: i32) -> i32 {
    let mut it = 0;
    let mut tmp: i32;
...
pub fn check_wrong_position(map:&mut Vec<Vec<i32>>, player: i32, x: i32, y: i32) -> i32 {
...
pub fn check_three_position(map:&mut Vec<Vec<i32>>, player: i32, x: i32, y: i32) -> i32 {
...
pub fn check_eat_position(map:&mut Vec<Vec<i32>>, player: i32, x: i32, y: i32) -> i32 {
    let mut eat_nb = 0;
...
fn eat_stone(map:&mut Vec<Vec<i32>>, poslist: Vec<(i32, i32)>) -> i32 {
    let mut eat_nb = 0;
    for (x, y) in poslist {
