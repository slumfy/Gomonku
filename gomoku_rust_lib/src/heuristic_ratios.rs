...
pub static PREVENT_OPPONENT_WIN_BY_CAPTURE: i64 = UNBLOCKABLE_FIVE_IN_A_ROW * 5;
pub static UNBLOCKABLE_FIVE_IN_A_ROW: i64 = FIVE_IN_A_ROW * 5;
pub static FIVE_IN_A_ROW: i64 = DOUBLE_BLOCK_FOUR_IN_A_ROW * 5;
pub static DOUBLE_BLOCK_FOUR_IN_A_ROW: i64 = FREE_FOUR_IN_A_ROW * 5;
pub static FREE_FOUR_IN_A_ROW: i64 = DOUBLE_BLOCK_SPLIT_THREE_IN_A_ROW * 5;
pub static DOUBLE_BLOCK_SPLIT_THREE_IN_A_ROW: i64 = SIMPLE_BLOCK_THREE_IN_A_ROW * 5;
pub static SIMPLE_BLOCK_THREE_IN_A_ROW: i64 = FREE_THREE_IN_A_ROW * 5;
pub static FREE_THREE_IN_A_ROW: i64 = CAPTURE_STONE * 5;
pub static CAPTURE_STONE: i64 = SIMPLE_BLOCK_TWO_IN_A_ROW * 5;
pub static SIMPLE_BLOCK_TWO_IN_A_ROW: i64 = FREE_TWO_IN_A_ROW * 5;
pub static FREE_TWO_IN_A_ROW: i64 = FOUR_IN_A_ROW_WITH_ONE_BLOCKER * 5;
pub static FOUR_IN_A_ROW_WITH_ONE_BLOCKER: i64 = 10;
...
pub fn exponential_heuristic_capture_stone_calculator(opponent_stone_captured: i8) -> i64 {
    ...
    if opponent_stone_captured >= 8 {
        return PREVENT_OPPONENT_WIN_BY_CAPTURE;
    }
    while multiplier > 1 {
        value = value * 2;
        multiplier -= 1;
