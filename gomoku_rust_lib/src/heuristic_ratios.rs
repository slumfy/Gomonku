...
pub static HEURISTIC_DOUBLE_BLOCK_FOUR_IN_A_ROW: i64 = HEURISTIC_FREE_FOUR_IN_A_ROW * 10;
...
pub static HEURISTIC_SIMPLE_BLOCK_THREE_IN_A_ROW: i64 = HEURISTIC_CAPTURE_STONE * 10;
pub static HEURISTIC_CAPTURE_STONE: i64 = HEURISTIC_FREE_THREE_IN_A_ROW * 5;
...
pub static HEURISTIC_FOUR_IN_A_ROW_WITH_ONE_BLOCKER: i64 = HEURISTIC_FREE_TWO_IN_A_ROW * 5;
pub static HEURISTIC_FREE_TWO_IN_A_ROW: i64 = 10;
...
pub static HEURISTIC_PATTERN: [[i64; 3]; 9] = [
    ...
    [
        ...
        HEURISTIC_CAPTURE_STONE,
        HEURISTIC_CAPTURE_STONE / 3,
    ], // three  .XXX....
    [HEURISTIC_FREE_THREE_IN_A_ROW / 2, 0, 0], // split three .X.XX...
    [HEURISTIC_FREE_THREE_IN_A_ROW / 2, 0, 0], // split three rev .XX.X...
    [HEURISTIC_FREE_TWO_IN_A_ROW, -HEURISTIC_CAPTURE_STONE, 0], // double 	.XX.....
];
...
pub fn exponential_heuristic_capture_stone_calculator(opponent_stone_captured: i8) -> i64 {
    ...
    let mut value = HEURISTIC_CAPTURE_STONE;
