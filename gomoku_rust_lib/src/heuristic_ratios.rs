...
pub static HEURISTIC_MIN_VALUE: i32 = i32::MIN + 1;
...
pub static HEURISTIC_DOUBLE_BLOCK_FOUR_IN_A_ROW: i32 = HEURISTIC_SIMPLE_BLOCK_THREE_IN_A_ROW * 5;
pub static HEURISTIC_SIMPLE_BLOCK_THREE_IN_A_ROW: i32 = HEURISTIC_PREVENT_CAPTURE_STONE * 5;
pub static HEURISTIC_PREVENT_CAPTURE_STONE: i32 = HEURISTIC_FREE_FOUR_IN_A_ROW * 5;
pub static HEURISTIC_FREE_FOUR_IN_A_ROW: i32 = HEURISTIC_FREE_THREE_IN_A_ROW * 5;
pub static HEURISTIC_FREE_THREE_IN_A_ROW: i32 = HEURISTIC_SIMPLE_BLOCK_TWO_IN_A_ROW * 5;
pub static HEURISTIC_SIMPLE_BLOCK_TWO_IN_A_ROW: i32 = HEURISTIC_FREE_TWO_IN_A_ROW * 5;
pub static HEURISTIC_FREE_TWO_IN_A_ROW: i32 = HEURISTIC_FOUR_IN_A_ROW_WITH_ONE_BLOCKER * 5;
pub static HEURISTIC_FOUR_IN_A_ROW_WITH_ONE_BLOCKER: i32 = 10;
pub static HEURISTIC_THREE_IN_A_ROW_ONE_BLOCKER: i32 = HEURISTIC_POSSIBLE_AXE_DEVELOPMENT * 5;
...
pub static HEURISTIC_PATTERN: [[i32; 3]; 10] = [
    ...
    [
        ...
        HEURISTIC_FOUR_IN_A_ROW_WITH_ONE_BLOCKER,
        0,
    ], // four .XXXX...
    [HEURISTIC_FREE_FOUR_IN_A_ROW, 0, 0], // split four 3 .XXX.X..
    [HEURISTIC_FREE_FOUR_IN_A_ROW, 0, 0], // split four 1 .X.XXX..
    [HEURISTIC_FREE_FOUR_IN_A_ROW, 0, 0], // split four 2 .XX.XX..
    [
...
pub fn exponential_heuristic_prevent_capture_stone_calculator(opponent_stone_captured: i8) -> i32 {
