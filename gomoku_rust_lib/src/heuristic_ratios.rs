...
pub static HEURISTIC_CAPTURE_TEN_STONE: i64 = HEURISTIC_MAX_VALUE;
pub static _HEURISTIC_CAPTURE_AN_OPPONENT_FIVE_IN_A_ROW: i64 =
...
pub static HEURISTIC_PATTERN: [[i64; 3]; 10] = [
    [
...
pub static HEURISTIC_BLOCKER: [[i64; 3]; 10] = [
    [0, 0, 0],                                           // five XXXXX...
