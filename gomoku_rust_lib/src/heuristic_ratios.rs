...
pub static HEURISTIC_DOUBLE_BLOCK_FOUR_IN_A_ROW: i64 = HEURISTIC_FREE_FOUR_IN_A_ROW * 2;
...
pub static HEURISTIC_SIMPLE_BLOCK_THREE_IN_A_ROW: i64 = HEURISTIC_CAPTURE_STONE * 2;
...
pub static HEURISTIC_SIMPLE_BLOCK_TWO_IN_A_ROW: i64 = HEURISTIC_FREE_TWO_IN_A_ROW * 2;
...
pub fn exponential_heuristic_capture_stone_calculator(opponent_stone_captured: i8) -> i64 {
    let mut multiplier = opponent_stone_captured / 4;
